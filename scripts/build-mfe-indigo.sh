...
pip uninstall -y tutor-indigo-stepwisemath tutor-mfe tutor

pip install tutor==${TUTOR_VERSION}
pip install tutor-mfe==18.0.1
pip install git+https://github.com/StepwiseMath/tutor-indigo-stepwisemath@${OPENEDX_RELEASE}
