...
RUN --mount=type=cache,target=/root/.npm,sharing=shared cd /openedx/app/frontend-component-header && install-peerdeps --dev -Y /openedx/app/frontend-component-header/
